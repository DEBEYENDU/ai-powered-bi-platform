...
def assess_risk(
    ...
    if trend == "decreasing":
        risk_factors.append(
            {"factor": "declining_trend", "score": 60, "explanation": "Downward trend detected"}
        )
    elif trend == "volatile":
        risk_factors.append(
            {"factor": "volatility", "score": 70, "explanation": "High volatility in predictions"}
        )
    else:
        risk_factors.append(
            {"factor": "trend", "score": 20, "explanation": "Stable/increasing trend"}
        )
    ...
    if r2 < 0.5:
        risk_factors.append(
            {"factor": "model_confidence", "score": 60, "explanation": "Low model accuracy"}
        )
    elif r2 < 0.7:
        risk_factors.append(
            {"factor": "model_confidence", "score": 35, "explanation": "Moderate model accuracy"}
        )
    else:
        risk_factors.append(
            {"factor": "model_confidence", "score": 15, "explanation": "High model accuracy"}
        )
    ...
    if predictions:
        ...
        if avg_val != 0 and avg_width / abs(avg_val) > 0.5:
            risk_factors.append(
                {"factor": "uncertainty", "score": 50, "explanation": "Wide confidence intervals"}
            )
        else:
            risk_factors.append(
                {"factor": "uncertainty", "score": 15, "explanation": "Narrow confidence intervals"}
            )

...
class ReportTemplate(BaseModel):
    ...
    def active_version(self) -> TemplateVersion | None:
...
class TemplateEngine:
    ...
    def create(
        ...
        tpl.versions.append(
            TemplateVersion(version_number=1, layout=merged, sections=list(sections or []))
        )
    ...
    def update(
        ...
        version = TemplateVersion(
            ...
            else copy.deepcopy(tpl.versions[-1].sections),

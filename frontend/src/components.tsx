...
const NAV: Array<[string, string]> = [
  ...
  ["KB Upload", "/knowledge/upload"],
  ["KB Collections", "/knowledge/collections"],
  ["KB Search", "/knowledge/search"],
  ["KB RAG Chat", "/knowledge/rag"],
  ["MLOps", "/mlops"],
  ["MLOps Models", "/mlops/models"],
  ["MLOps Experiments", "/mlops/experiments"],
  ["MLOps Training", "/mlops/training"],
  ["MLOps Deployments", "/mlops/deployments"],
  ["MLOps Monitoring", "/mlops/monitoring"],
  ["MLOps Drift", "/mlops/drift"],
  ["Governance", "/governance"],
  ["Governance Policies", "/governance/policies"],
  ["Governance Security", "/governance/security"],
  ["Governance Classifications", "/governance/classifications"],
  ["Health", "/health"],
  ["Metrics", "/metrics"],
  ["Audit", "/audit"],
  ["Alerts", "/alerts"],
